...
El objetivo es explorar cómo integrar esta tecnología en un sitio web de productos (como placares a medida), permitiendo al usuario visualizar el modelo en 3D y proyectarlo en su entorno real mediante la cámara del dispositivo.
